    ...
    <nav className="bg-white border-b border-[#e8e0d0] sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <Link href="/urunler/toptan"><span className="text-xs font-bold hover:text-[#B8860B] cursor-pointer">TOPTAN</span></Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/profil"><User size={18} className="cursor-pointer hover:text-[#B8860B]" /></Link>
